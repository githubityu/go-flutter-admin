...
// @Param     data  body      authority.SysDictionary           true  "SysDictionary模型"
...
func (s *DictionaryApi) CreateSysDictionary(c *gin.Context) {
	var dictionary authority.SysDictionary
...
// @Router    /sysDictionary/deleteSysDictionary [post]
...
// @Router    /sysDictionary/updateSysDictionary [post]
...
// @accept    application/json
// @Produce   application/json
// @Param     data  query     authority.SysDictionary                                       true  "ID或字典英名"
// @Success   200   {object}  response.Response{data=map[string]interface{},msg=string}  "用id查询SysDictionary"
// @Router    /sysDictionary/findSysDictionary [post]
func (s *DictionaryApi) FindSysDictionary(c *gin.Context) {
	...
	if err != nil {
		global.TD27_LOG.Error("字典未创建或未开启!", zap.Error(err))
